...
@Component({
  selector: 'app-hdesk-list-user',
  templateUrl: './hdesk-list-user.component.html',
  styleUrls: ['./hdesk-list-user.component.css']
})
export class HdeskListUserComponent implements OnInit {
